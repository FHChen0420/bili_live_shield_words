...
words =  [ 
    ...
    "脑子瓦特", "恐怖漫画", "乡关何处", "有容乃大", "是全裸的", "最后一课",
    "黑暗之魂", "求生之路", "上古卷轴", "侠盗飞车", "尸体派对", "动物之森",
    "31年", "1月23", "7月1日", "7月5日", "7月13", "8月17日", "12月28", "你是你我是我", #汉字格式的日期也会被屏蔽，这里没写出来

    ### 字符间隔相关
    "奥#1数#1[魔默]", "收#1[妹弟女]#1[妹弟儿]", "回#1来#3谢", "观#1众#3v", "姐#1姐#5[逼b]", "妹#1妹#5[逼b]", "弟#1弟#6大", "v#2p#2n", "湿#2视#2频", "[01]#2找#2[01]",
    ...
    "[01]#2还#1是#2[01]", "你#3画#3我#3猜", "清#6透#6世#6界", "n#2t#2t#1o#1p", "w#4e#4i#4b#4o", "一#6个#6人#6寂#6寞", "不#1要#6这#1种#1事#1情",
    ...
    ### 字母+汉字（仅作简单处理）
    "si法", "你ma", "mei药", "媚yao", "lu#2发",  "看#3id", "加#4qq", "dio#3大", "diao#3大", "ri#1[我你]", 
