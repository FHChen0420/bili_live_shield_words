...
words =  [ 
    ...
    ### 字符间隔相关
    "回#1来#3谢", "观#1众#3v", "姐#1姐#5[逼b]", "妹#1妹#5[逼b]", "v#2p#2n", "[逼b]#3看#1吗", "搜#3这#1个", "投#3比#1赛", "看#3头#1像", "6#3月#24", "同#3性#3恋",
    "道#3上#3飞", "名#3字#3看", "我#3是#3处", "下#3面#3好", "少#3女#3[下自]", "直#3播#3[日草艹操曰]",
    ...
    "[逼b]#1里", "[批阴]#1毛", "[吞吃]#1精", "[左右]#1倾", "[两二2]#1会", "[玩双晕]#1奶", "[处下熟]#1女", "[调传宗]#1教", "[鸡己性]#1吧", "[湿射硬]#1了",
    "[贫小平双]#1乳", "[条包孢窑梯]#1子", "[杀去爽干操草爹妈]#1死", "[插吸]#1[你他她它]", "[.。·]#1[cf]", "[傻沙煞撒]#1[逼比笔]",
    "网#2恋", "巨#2乳", "自#2尽", "涩#2情", "人#2权", "逼#2真", "翻#2墙", "[逼b]#2毛", "湿#2视#2频",
    "支#3那", "去#3搜", "百#3d", "自#3杀", "共#3产", "毛#3东", "手#3银", "涩#3图", "肉#3棒", "伪#3娘",
