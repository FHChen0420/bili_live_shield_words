...
words =  [ 
    ...
    "脱光", "丝袜", "漏点", "媚药", "很太", "热舞", "牛子", "给口", "发情",
    "肥猪", "下贱", "你妈", "月半", "送妈", "嘴臭", "拉屎", "撤硕", "低俗", "憨批",
    "刁大", "禽兽", "畜生", "吃屎", "智障", "小丑", "杂种",
    "美国", "米国", "台湾", "香港", "澳门", "日吹",
    ...
    "gc", "hw", "hk", "qd", "rh", "zf", "abs", "cjp", "cnm", "gay", "ghs", "kui", "lsp", "nmb", "nmd", "ply", "roc", "scp", "soe", "tmd", "usl", "wic", "wjb", "xxd",
    "anal", "arms", "boki", "dang", "drug", "frog", "fuck", "knee", "kuma", "liya", "loli", "nmsl", "rori", "sina", "tank", "yuan",
    "baidu", "bajiu", "bitch", "ching", "elder", "luoli", "obama", "ruler", "sager", "secom", "shina",
    ...
    "有神明", "一直播", "看名字", "报警了", "金小姐", "被墙了", "大三元", "甜蜜蜜",
    ...
    ### 字符间隔相关
    "奥#1数#1[魔默]", "一#1口#1[气吃喝]", "收#1[妹弟女]#1[妹弟儿]", "下#1面#2[松紧]", "回#1来#3谢", "观#1众#3v", "还#1没#3封", "[姐妹]#1[姐妹]#5[逼b]", "弟#1弟#6大", 
    ...
    "射#4身#1上", "童#4收#1养", "买#4烟#1花", "删#4评#1论", "改#4中#1国", "花#4全#1裸", "天#4安#4门", "萝#4莉#4控", "正#4太#4控", "加#4速#4器", "习#4大#4大", 
    "[你尼]#4[妈马吗码蚂玛犸嘛母m家]#4[币比逼必猪狗b]", "[大小妈姐妹哥弟一二三四五六七八九]#4[小姐妹哥弟一二三四五六七八九]#5[在来做进]",
    "手#5指#5插", "徐#5上#5爽", "许#5艾#5莉", "谢#5日#5双", "下#5面#5痒", "崔#5塔#5娜", "包#5含#5雪",
    "[马周]#5上#5[文梦]", "[鲁撸露]#5一#5发", "[徐许]#5[上玩日]#5[碧双霜雪]", "[马就]#5[想上]#5[鲁撸噜门们]",
    "[%sail百]#6[就上去还点被了射让]#5[来射车有点出被入]"%(hz_du_1), "[日草艹操干曰死烧解透跳杀]#6[你尼我他她它]#5[妈马吗码蚂玛犸嘛母m家]",
    "文#6古#6花", "看#6地#6方", "不#6钱#6[啊3]", "[谢x]#6s#6w",
    "准#1备#3纸#1巾", "那#1个#4奶#1奶", "羊#1羊#4结#1婚", "学#1生#4学#1生", "妈#1妈#6唱#1歌", "不#1论#6生#1死", "[姐妹哥]#1[姐妹哥]#6大#1腿", "找#1工#1作#3加",
    "[01]#2还#1是#2[01]", "你#3画#3我#3猜", "闭#3关#3锁#3国", "不#3穿#3衣#3服", "清#6透#6世#6界", "一#6个#6人#6寂#6寞", "不#1要#6这#1种#1事#1情",
    "[.]#6c#6c", "a#6j#6p", "s#2e#2x", "t#6l#6y", "v#4b#3o", "v#2p#2n", "x#4j#4p", "x#6y#6z", "a#3s#3m#3r", "f#6l#6d#6f", "n#2t#1o#1p",
    "n#2t#2t#1o#1p", "r#6i#6o#6t#6s", "w#4e#4i#4b#4o", "t#6m#6m#6s#6m#6e", "y#4a#4y#4e#4a#4e", "7#1[.]#15", "1#1[.]#12#13", "1#32#33#34#35#36#37#38#39#30",
    ...
    "自#3[杀殺慰]", "鸡#3[巴八8⑧]", "[涩色]#3网", "被#3[日草艹操曰]", "[习習吊弔]#3大", "[草艹操]#3b", "[下压]#3注", "[黄色h]#3片", "[做作坐座]#3爱", 
...
rules = {
    ...
    "([啪绿弯湾内色涩])(?= ?\\1)": lambda x: x.group(1) + sp,
    ...
    "尼嚎": "你好", "人妖": "人Yao", "咖喱 ?人": "咖喱Ren", "全 ?家 ?炸": "全 家Zha", "糖尿病": "糖尿bing",
    ...
    "好吵": insert_space, "琐事": insert_space,
    ...
    "[你您他她这个](?=[^\s\d个]{0,3}?[脸嘴鼻脑舌货猴胖矮丑烦笨傻蠢怪臭土歪睁垃])": add_space,
    "[你您他这那](?=.*?位.*?要求)": add_space,
    "[你您他她](?=.*?东西)": add_space,
    "睁(?=[^\s睁]{0,3}?[开嘴脸鼻眼脑舌])": add_space,
    "脸(?=.*?像)" : add_space,
    "(?<![^你您他她这那a-zA-Z\r\n])[嘴脸鼻眼脑舌个](?=\S{0,3}?[样歪])" : add_space,
