...
words =  [ 
    ...
    "hw", "gc", "xi", "zf", "cnm", "kui", "lsp", "nmd", "tmd", "usl", "xxd", "boki", "dang", "drug", "knee", "kuma", "loli", "sina", 
    "bajiu", "luoli", "obama", "sager", "shina", "hentai", "reddit", "signal", "tiktok", "youtube",
    "ilibilib", "pilipili", "dilidili", "revolution", "neverforget",
    "535", "586", "604", "809", "881", "918", "1926", "1953", "1979", "1989", "g7", "g20", "j8",
    "不想活", "自由门", "咖啡因", "死灵魂", "白衬衫", "生理期", "空气炮", "黑历史", "就去泡", "一本道",
    "被传染", "网易云", "爱奇艺", "支付宝", "劈腿男", "缘之空", "一起死", "稻田上", "安眠药", "接班人", 
    "纪念日", "为自由", "莉莉安", "李医生", "右大人", "绞肉机", "不唱歌", "女菩萨", "毕业歌", "老鼠台", 
    "梦大师", "脱衣服", "我要射", "度一下", "来一发", "小柜子", "奇酷比", "比基尼", "就这？",
    "四一二", "五三五", "八一七", "九一八", "九九六", "一九二六", "一九五三", 
    "自由之门", "继续前进", "并肩同行", "焕然一新", "奥斯曼人", "二氧化碳", "阿里巴巴", "恐怖分子", "恐怖份子", "田所浩二", "b站员工" , "波涛汹涌",
    "身经百战", "黑框眼镜", "谈笑风生", "无可奉告", "活不下去", "飘飘欲仙", "动物之森", "分割人生", "坟头蹦迪", "嘀哩嘀哩", "我是黄金",
    "你是你我是我",

    ### 字符间隔相关
    "l#1u#2发", "回#1来#3谢", "姐#1姐#5[逼b]", "妹#1妹#5[逼b]", "看#3i#1d", "[逼b]#3看#1吗", "搜#3这#1个",
    "道#3上#3飞", "名#3字#3看", "我#3是#3处", "下#3面#3好", "白#3一#3下", "少#3女#3[下自]", "直#3播#3[日草操]", 
    "射#4身#1上", "童#4收#1养", "v#4b#3o", "天#4安#4门", "萝#4莉#4控", "死#4[你他她]#5[吗嘛妈马]", "手#5指#5插", "[鲁撸露]#5一#5发",
    "[日草操干]#6[你我他她它]#5[妈吗马嘛]", "文#6古#6花", "看#6地#6方", "不#6钱#6啊",
    "准#1备#3纸#1巾", "那#1个#4奶#1奶", "羊#1羊#4结#1婚", "学#1生#4学#1生", "r#1i#6[你我他她它]#5[妈吗马嘛]", "清#6透#6世#6界", "w#4e#4i#4b#4o", "一#6个#6人#6寂#6寞",
    "[贫小平]#1乳", "色#1[逼b]", "[逼b]#1里", "[傻沙煞撒]#1[逼比笔]", "[插吸]#1[你他她它]", "称#1[王皇帝]", "[.。·]#1[cf]", "点#1[人1cfl]", 
    "巨#2乳", "自#2尽", "[习習]#3大", "[草操]#3b", "被#3[日草操]", "[做作坐座]#3爱", "支#3那", "去#3搜", "[下压]#3注", "百#3d", "h#3片", "自#3杀", "光#3光", "共#3产",
    ...
    # "书记", "想死", "屏蔽", "干妈", "啪啪", "啪啪啪", "点点点", "64", "73", "89", "404",
...
rules = {
    ### 单字/特殊字符
    "翠": "Cui", "尻": "Kao", "爬": "Pa", "痒": "Yang", "淫":"Yin", "岿": "巍", "屌": "吊", "蛤": "Ha", "党": "Dαng",
    ...
    "(?a)(?<!\\w)(6 ?)(4)(?!\\w)": lambda x: x.group(1)+"４", # 下列三条规则没法处理前方有空格的情况，想要处理好的话得分组再匹配一次
    "(?a)(?<!\\w)(7 ?)(3)(?!\\w)": lambda x: x.group(1)+"３",
    "(?a)(?<!\\w)(8)( ?9)": lambda x: "８"+x.group(2),
    "(4 ?0 ?)(4)": lambda x: x.group(1)+"４",
