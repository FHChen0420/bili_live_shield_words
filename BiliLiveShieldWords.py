...
words =  [ 
    ...
    "四六", "五四", "七一", "七五", "九八",
    "即为", "试看", "豪迈", "耳语", "迷途", "触摸", "初心", "慎重", "三尺",
    "许愿", "代打", "躺平", "要素", "精湛", "上街", "读错", "性吧", "下乡", "闪灵",
    "百年", "鸡脖", "没了",
    "与正", "蒂亚", "稻上", "飞草", "熊学", "伐龙", "家明", "马云",
    "ロリ", "はま", "ハマ", "しな", "シナ", "くま", "死ね", "映画", 

    "hw", "gc", "cjp", "cnm", "kui", "lsp", "nmd", "ply", "tmd", "usl", "xxd", "boki", "dang", "drug", "knee", "kuma", "loli", "sina", 
    ...
    "巨#2乳", "自#2尽", "[习習]#3大", "[草操]#3b", "被#3[日草操]", "[做作坐座]#3爱", "支#3那", "去#3搜", "[下压]#3注", "百#3d", "h#3片", "自#3杀", "共#3产",
    ...
    # "爸爸", "啪啪", "啪#2啪#2啪", "鸡#2鸡", "光#3光", "共#4共", "点点点", "大大大大大", 
