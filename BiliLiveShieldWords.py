...
words =  [ 
    ...
    "波涛汹涌", "我是黄金", "尸体派对", "没有敌人", "奥斯曼人", "奥数魔刃", "奥数魔人",
    "你是你我是我",

    ### 字符间隔相关
    "回#1来#3谢", "姐#1姐#5[逼b]", "妹#1妹#5[逼b]", "[逼b]#3看#1吗", "搜#3这#1个",
    "道#3上#3飞", "名#3字#3看", "我#3是#3处", "下#3面#3好", "[白干]#3一#3下", "少#3女#3[下自]", "直#3播#3[日草操]",
    "射#4身#1上", "童#4收#1养", "v#4b#3o", "天#4安#4门", "萝#4莉#4控", "[死烧]#4[你他她]#5[吗嘛妈马m]", "手#5指#5插", "[鲁撸露]#5一#5发", "徐#5上#5爽",
    ...
    "[逼b]#1里", "[左右]#1倾", "[杀去爽]#1死", "[处下熟]#1女", "[贫小平]#1乳", "[调传宗]#1教", "[鸡己性]#1吧", "[湿射硬没]#1了", "[条包孢窑梯]#1子",
