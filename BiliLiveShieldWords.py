...
words =  [ 
    ...
    "不想活", "自由门", "咖啡因", "死灵魂", "白衬衫", "生理期", "空气炮", "黑历史", "就去泡",
    "纪念日", "为自由", "莉莉安", "李医生", "右大人", "绞肉机", "不唱歌", "女菩萨",
    ...
    ### 字符间隔相关
    "[贫小平]#1乳", "[傻沙煞撒]#1[逼比笔]", "插#1[你他她它]", "[草操]#3b", "被#3[草曹操]", "少女#3[下自]", "[做作坐座]#3爱", "[看好]#4胸",
    "巨#2乳", "去#3搜", "下#3注", "车#4震", "小#4平", "再#4任", "明#4泽", "援#4交", "后#4入", "留#5水", 
