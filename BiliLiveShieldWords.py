...
words =  [ 
    ...
    ### 字符间隔相关
    "v#4b#3o", "道#3上#3飞", "名#3字#3看", "我#3是#3处", "下#3面#3好", "看#3i#1d", "[b逼]#3看#1吗", "直#3播#3[日草操]", "射#4身#1上", "天#4安#4门", "萝#4莉#4控",
    ...
    "8#29", "巨#2乳", "自#2尽", "[草操]#3b", "被#3[日草操]", "少女#3[下自]", "[做作坐座]#3爱", "去#3搜", "下#3注", "百#3d", "自#3杀", "光#3光",
