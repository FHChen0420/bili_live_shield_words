...
words =  [ 
    ...
    "71", "404", "535", "586", "604", "809", "881", "918", "1921", "1926", "1953", "1979", "1989", "g7", "g20", "j8",
    ...
    "射#4身#1上", "v#4b#3o", "天#4安#4门", "萝#4莉#4控", "死#4[你他她]#5[吗嘛妈马]", "手#5指#5插", "文#6古#6花", "看#6地#6方", "不#6钱#6啊",
    "那#1个#4奶#1奶", "羊#1羊#4结#1婚", "清#6透#6世#6界", "w#4e#4i#4b#4o", "一#6个#6人#6寂#6寞",
    ...
    "六#4四", "八#4九", "[日草操干]#4[姐妹奶]", "[看好]#4胸", "车#4震", "小#4平", "再#4任", "明#4泽", "援#4交", "后#4入", "天#4门", "流#4世", "留#5水", "性#5爱",
    "萝#6[利俐]", "罗#6莉",
...
rules = {
    ...
    "([干湿日].*?)(视.*?)(频)": lambda x: x.group(1)+fill(x.group(2),3)+x.group(3), # "湿#2视#2频"与"[干日]#7视#1频"统一处理，大概率还有其他"X+视频"的情况
