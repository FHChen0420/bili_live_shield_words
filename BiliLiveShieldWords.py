...
words =  [ 
    ...
    "胖次", "欧派", "罩杯", "嘿咻", "内内", "吹气", "掏耳", "助眠",
    "重口", "射爆", "勃起", "出轨", "黑化", "叫鸡", "痴汉", "进裙", "奶头", "鸡儿",
    "肥猪", "下贱", "你妈", "月半", "送妈", "嘴臭", "拉屎", "撤硕", "我日",
    "美国", "米国", "台湾", "香港", "澳门", "成都", "日吹", "精美", "精日", 
    "油管", "推特", "微博", "新浪", "抖音", "优酷", 
    "皇帝", "皇宫", "庙堂", "磕头", "还愿", "安乐", "包养", "法会",
    "赌博", "扑克", "彩票", "发票", "博彩", "菠菜", "硫酸", "甲烷", "煤气",
    "四六", "五四", "七一", "七五", "九八",
    "即为", "试看", "豪迈", "耳语", "迷途", "触摸", "初心", "慎重", "三尺", "鲍鱼",
    "许愿", "代打", "躺平", "要素", "精湛", "上街", "读错", "下乡", "闪灵", "退钱",
    "百年", "鸡脖", "红魔", "庆典", "广场", "秃鹰", "细腻", "泼墨", "发酵", "电竞",
    "一哥", "动森", "鸣人", "映画", "老母", "青蛙", "秃子", "矮子",
    "与正", "蒂亚", "稻上", "飞草", "熊学", "伐龙", "家明", "马云", "唐可", "泽东",
    "ロリ", "はま", "ハマ", "しな", "シナ", "くま",

    "hw", "gc", "cjp", "cnm", "ghs", "kui", "lsp", "nmb", "nmd", "ply", "tmd", "usl", "xxd", "boki", "dang", "drug", "fuck", "knee", "kuma", "loli", "sina", 
    "bajiu", "bitch", "luoli", "obama", "sager", "secom", "shina", "hentai", "reddit", "signal", "tiktok", "excited", "youtube", "exciting", "revolution", "neverforget",
    ...
    "波涛汹涌", "我是黄金", "尸体派对", "没有敌人", "少女之心", "奥斯曼人", "奥数魔刃", "奥数魔人", "孩子的鞋",
    "你是你我是我",

    ### 字符间隔相关
    "回#1来#3谢", "姐#1姐#5[逼b]", "妹#1妹#5[逼b]", "[逼b]#3看#1吗", "搜#3这#1个", "同#3性#3恋",
    "道#3上#3飞", "名#3字#3看", "我#3是#3处", "下#3面#3好", "[白干]#3一#3下", "少#3女#3[下自]", "直#3播#3[日草操]",
    "射#4身#1上", "童#4收#1养", "买#4烟#1花", "删#4评#1论", "v#4b#3o", "天#4安#4门", "萝#4莉#4控", "手#5指#5插", "[鲁撸露]#5一#5发", "徐#5上#5爽",
    "[日草操干死烧]#6[你我他她它]#5[妈吗马嘛母m]", "r#1i#6[你我他她它]#5[妈吗马嘛母m]", "文#6古#6花", "看#6地#6方", "不#6钱#6啊",
    ...
    "巨#2乳", "自#2尽", "涩#2情", "人#2权", "[逼b]#2毛", "湿#2视#2频",
    "支#3那", "去#3搜", "百#3d", "自#3杀", "共#3产", "毛#3东", "手#3银", "涩#3图", 
    "[涩色]#3网", "被#3[日草操]", "[习習吊弔]#3大", "[草操]#3b", "[下压]#3注", "[黄色h]#3片", "[做作坐座]#3爱", 
    "六#4四", "八#4九", "车#4震", "小#4平", "援#4交", "后#4入", "天#4门", "流#4世", "主#4席", "黄#4网", "明#4[泽z]", "[连再]#4任", "[看好]#4胸", "[日草操干]#4[姐妹奶]", 
    "留#5水", "性#5爱", "威#5雄",
    "康#6买", "罗#6莉", "萝#6[利俐]", "[逼b]#6紧", "[习習]#6近",
    ...
    ### 以下屏蔽词已做其它处理（见rules）
    # "hk", "tg", "tw", "xi", "zf", "abs", "sex", "tam", "xjp", "anal", "arms", "asmr", "fldf", "ntop", "baidu", "tmmsme", "yayeae",
