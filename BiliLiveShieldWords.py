...
words =  [ 
    ...
    "玩#1[逼奶]", "吉#1[尔儿]", "射#1[爆爽]", "法#1[会能弄]", "乳#1[头首量]", "称#1[王皇帝]", "涩#1[气批片p]",
    "大#1[吊弔麻胸]", "点#1[人1cfl]", "死#1[吧妈法了ね]", "色#1[图情皮批逼戒b]",
    "[逼b]#1里", "[批阴]#1毛", "[左右]#1倾", "[两二2]#1会", "[杀去爽]#1死", "[处下熟]#1女", "[贫小平]#1乳", "[调传宗]#1教", "[鸡己性]#1吧", "[湿射硬没]#1了", "[条包孢窑梯]#1子",
