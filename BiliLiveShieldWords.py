...
words =  [ 
    ...
    "巨#2乳", "去#3搜", "下#3注", "车#4震", "小#4平", "再#4任", "明#4泽", "援#4交", "后#4入", "天#4门", "流#4世", "留#5水", "性#5爱",
    "v#4b#3o", "道#3上#3飞", "名#3字#3看", "我#3是#3处", "射#4身#1上", "天#4安#4门", "文#6古#6花", "看#6地#6方", 
    "清#6透#6世#6界", "一#6个#6人#6寂#6寞", "[.。·]#1[cf]", "点#1[1cfl]", "百#3d",
    ### 拼音组合相关
    "[%s]#1都"%(hz_bai),
    "[%scx]#2[%sp]"%(hz_xi,hz_pin_ping),
    "[%s]#3[%s]"%(hz_ba,hz_jiu),
