...
words =  [ 
    ...
    ### 字符间隔相关
    "v#4b#3o", "道#3上#3飞", "名#3字#3看", "我#3是#3处", "下#3面#3好", "少#3女#3[下自]", "看#3i#1d", "[b逼]#3看#1吗", "直#3播#3[日草操]", 
    "射#4身#1上", "天#4安#4门", "萝#4莉#4控", "手#5指#5插", "文#6古#6花", "看#6地#6方", "不#6钱#6啊",
    "那#1个#4奶#1奶", "羊#1羊#4结#1婚", "清#6透#6世#6界", "w#4e#4i#4b#4o", "一#6个#6人#6寂#6寞",
    "[贫小平]#1乳", "色#1[逼b]", "[傻沙煞撒]#1[逼比笔]", "[插吸]#1[你他她它]", "称#1[王皇帝]", "[.。·]#1[cf]", "点#1[人1cfl]", 
    "8#29", "巨#2乳", "自#2尽", "[草操]#3b", "被#3[日草操]", "[做作坐座]#3爱", "支#3那", "去#3搜", "下#3注", "百#3d", "自#3杀", "光#3光",
