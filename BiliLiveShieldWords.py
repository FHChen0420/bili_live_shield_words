...
words =  [ 
    ...
    "天安", "安门", "审查", "番号", "之那", "赤字", "出访", "民众",
    "生事", "闹事", "闹剧", "游行", "颠覆", "起义", "抗争", "革命", "乱暴", "暴乱",
    "囚禁", "施虐", "虐待", "捆绑", "割腕", "剥削", "贿赂", "匕首", "鞭尸", 
    "疫情", "新冠", "包粉", "白粉", "媚药",
    "中出", "高潮", "被透", "走光", "诱惑", "双飞", "梆硬",
    "喘气", "喘息", "呻吟", "处男", "绅士", "抖m" , "h漫" , "性癖", "无码", "开冲",
    "胖次", "欧派", "罩杯", "嘿咻", "内内", "吹气", "掏耳", "助眠",
    "重口", "射爆", "勃起", "出轨", "黑化", "叫鸡", "痴汉", "进裙", "奶头", "鸡儿",
    "肥猪", "下贱", "你妈", "月半", "送妈", "嘴臭", "拉屎", 
    ...
    "bajiu", "bitch", "luoli", "obama", "sager", "secom", "shina", "hentai", "reddit", "signal", "tiktok", "youtube", "revolution", "neverforget",
    ...
    "性骚扰", "妖妖灵", "蛋炒饭", "异教徒", "跑得快", "顶不住", "劳动法",
    "四一二", "五三五", "八一七", "九一八", "九九六", "一九二六", "一九五三", 
    "自由之门", "继续前进", "并肩同行", "焕然一新", "二氧化碳", "阿里巴巴", "恐怖分子", "恐怖份子", "田所浩二", 
    "身经百战", "黑框眼镜", "谈笑风生", "无可奉告", "活不下去", "飘飘欲仙", "动物之森", "分割人生", "坟头蹦迪", "b站员工" , 
    "波涛汹涌", "我是黄金", "尸体派对", "没有敌人", "少女之心", "奥斯曼人", "奥数魔刃", "奥数魔人",
    "你是你我是我",

    ### 字符间隔相关
    "回#1来#3谢", "姐#1姐#5[逼b]", "妹#1妹#5[逼b]", "[逼b]#3看#1吗", "搜#3这#1个",
    "道#3上#3飞", "名#3字#3看", "我#3是#3处", "下#3面#3好", "[白干]#3一#3下", "少#3女#3[下自]", "直#3播#3[日草操]",
    "射#4身#1上", "童#4收#1养", "买#4烟#1花", "v#4b#3o", "天#4安#4门", "萝#4莉#4控", "手#5指#5插", "[鲁撸露]#5一#5发", "徐#5上#5爽",
    "[日草操干死烧]#6[你我他她它]#5[妈吗马嘛母m]", "r#1i#6[你我他她它]#5[妈吗马嘛母m]", "文#6古#6花", "看#6地#6方", "不#6钱#6啊",
    "准#1备#3纸#1巾", "那#1个#4奶#1奶", "羊#1羊#4结#1婚", "学#1生#4学#1生", "妈#1妈#6唱#1歌", "不#1论#6生#1死",
