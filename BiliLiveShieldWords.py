...
words =  [ 
    ...
    "巨#2乳", "自#2尽", "[草操]#3b", "被#3[日草操]", "[做作坐座]#3爱", "支#3那", "去#3搜", "[下压]#3注", "百#3d", "h#3片", "自#3杀", "光#3光", "共#3产",
    ...
    # "书记", "想死", "许愿", "啪啪", "啪啪啪", "点点点", "64", "73", "89", "404", #其余部分见rules 
