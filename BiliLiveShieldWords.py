...
words =  [ 
    ...
    "[马周]#5上#5[文梦]", "[鲁撸露]#5一#5发", "[徐许]#5[上玩]#5[碧双霜]", "[马就]#5[想上]#5[鲁撸噜门们]",
    ...
    "涩#1[气批片p]", "精#1[美日湛子]", "乳#1[头首量水摇]", "魂#1[一二三123]", "大#1[麻吊弔胸波奶胃]", "点#1[人1cfl]", "死#1[吧妈法ね]", "色#1[图情皮批逼戒狼b]",
...
rules = {
    ...
    "尼嚎": "你好", "人妖": "人Yao", "咖喱 ?人": "咖喱Ren", "全 ?家 ?炸": "全 家Zha",
