...
words =  [ 
    ...
    "excited", "youtube", "exciting", "revolution", "neverforget",
    ...
    "[日草操干死烧解]#6[你我他她它]#5[妈吗马嘛母m]", "r#1i#6[你我他她它]#5[妈吗马嘛母m]", "文#6古#6花", "看#6地#6方", "不#6钱#6[啊3]",
    ...
    "六#4四", "八#4九", "车#4震", "援#4交", "后#4入", "天#4门", "流#4世", "主#4席", "黄#4网", "明#4[泽z]", "[小进]#4平", "[连再]#4任", "[看好]#4胸", "[日草操干]#4[姐妹奶]", 
    "留#5水", "性#5爱", "威#5雄",
