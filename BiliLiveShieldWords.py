...
words =  [ 
    ### 一般屏蔽词（易变动）
    "即位", "修正", "领导", "特权", "候选", "警察", "军队", "部队", "政府",
    "在任", "下台", "冷战", "小熊", "汪洋", "提案", "红通", "腐败",
    ...
    "疫情", "新冠", "包粉", "白粉", "媚药",
    "中出", "高潮", "被透", "走光", "诱惑",
    "喘气", "喘息", "呻吟", "处男", "绅士", "抖m" , "h漫" , "性癖", "无码",
    "胖次", "欧派", "罩杯", "嘿咻", "内内", "吹气", "掏耳", "助眠",
    "重口", "射爆", "勃起", "出轨", "黑化", "叫鸡", "痴汉", "进裙", "奶头",
    ...
    "玩#1[逼奶]", "乳#1[头首量]", "称#1[王皇帝]", "涩#1[气批片p]", "大#1[吊弔麻胸]", "点#1[人1cfl]", "死#1[吧妈法了ね]", "色#1[图情皮批逼戒b]", 
    "[杀去]#1死", "[逼b]#1里", "[处下熟]#1女", "[贫小平]#1乳", "[调传宗]#1教", "[湿射硬没]#1了", "[条包孢窑梯]#1子",
