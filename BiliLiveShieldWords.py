...
words =  [ 
    ...
    "色蝴蝶", "不过审", "振动棒", "震动棒", "战车道", "臂当车", "小黄油", "小黄书", "炸学校", "你全家",
    "换平台",
    ...
    ### 字符间隔相关
    "奥#1数#1[魔默]", "收#1[妹弟女]#1[妹弟儿]", "回#1来#3谢", "观#1众#3v", "姐#1姐#5[逼b]", "妹#1妹#5[逼b]", "弟#1弟#6大", "v#2p#2n",
    ...
    "[贫小平双]#1乳", "[条包孢窑梯]#1子", "[杀去爽干操草爹妈饿]#1死", "[插吸]#1[你他她它]", "[.。·]#1[cf]", "[傻沙煞撒]#1[逼比笔]",
