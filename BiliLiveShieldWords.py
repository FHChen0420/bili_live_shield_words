...
words =  [ 
    ...
    "hw", "gc", "zf", "kui", "lsp", "usl", "xxd", "drug", "knee", "kuma", "loli", "mama", "sina", 
    "luoli", "sager", "shina", "hentai", "signal", "youtube", "revolution",
    "ilibilib", "pilipili", "dilidili", "404", "535", "604", "881", "1953", "g7", "g20", "j8",
    ...
    "身经百战", "黑框眼镜", "谈笑风生", "活不下去", "飘飘欲仙", "动物之森", "分割人生", "坟头蹦迪", "嘀哩嘀哩",
    "你是你我是我",
    ...
    ### 字符间隔相关
    "v#4b#3o", "道#3上#3飞", "名#3字#3看", "我#3是#3处", "下#3面#3好", "看#3i#1d", "射#4身#1上", "天#4安#4门",
    "手#5指#5插", "文#6古#6花", "看#6地#6方", "不#6钱#6啊", "那#1个#4奶#1奶", "清#6透#6世#6界", "w#4e#4i#4b#4o", "一#6个#6人#6寂#6寞",
    "[贫小平]#1乳", "色#1[逼b]", "[傻沙煞撒]#1[逼比笔]", "插#1[你他她它]", "称#1[王皇帝]", "[.。·]#1[cf]", "点#1[人1cfl]", 
    "巨#2乳", "[草操]#3b", "被#3[草曹操]", "少女#3[下自]", "[做作坐座]#3爱", "去#3搜", "下#3注", "百#3d", "光#3光",
