...
words =  [ 
    ...
    "许愿", "代打", "躺平", "熊学", "伐龙", "要素", "蒂亚", "稻上",
    "ロリ", "はま", "ハマ", "しな", "シナ", "くま", "死ね", "映画", 

    "hw", "gc", "zf", "cnm", "kui", "lsp", "nmd", "tmd", "usl", "xxd", "drug", "knee", "kuma", "loli", "sina", 
    ...
    "不想活", "自由门", "咖啡因", "死灵魂", "白衬衫", "生理期", "空气炮", "黑历史", "就去泡", "一本道", "被传染", "网易云", "爱奇艺", "就这？",
    "纪念日", "为自由", "莉莉安", "李医生", "右大人", "绞肉机", "不唱歌", "女菩萨", "发不出", "老鼠台", "缘之空", "一起死", "稻田上",
    ...
    ### 字符间隔相关
    "看#3i#1d", "[b逼]#3看#1吗", "道#3上#3飞", "名#3字#3看", "我#3是#3处", "下#3面#3好", "少#3女#3[下自]", "直#3播#3[日草操]", 
    "射#4身#1上", "v#4b#3o", "天#4安#4门", "萝#4莉#4控", "手#5指#5插", "文#6古#6花", "看#6地#6方", "不#6钱#6啊",
    "那#1个#4奶#1奶", "羊#1羊#4结#1婚", "清#6透#6世#6界", "w#4e#4i#4b#4o", "一#6个#6人#6寂#6寞",
    "[贫小平]#1乳", "色#1[逼b]", "[傻沙煞撒]#1[逼比笔]", "[插吸]#1[你他她它]", "称#1[王皇帝]", "[.。·]#1[cf]", "点#1[人1cfl]", 
    "巨#2乳", "自#2尽", "[草操]#3b", "被#3[日草操]", "[做作坐座]#3爱", "支#3那", "去#3搜", "下#3注", "百#3d", "自#3杀", "光#3光",
