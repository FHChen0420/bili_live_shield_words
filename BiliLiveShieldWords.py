...
words =  [ 
    ...
    "点#1点#1点", "大#1大#1大#1大#1大", "啪#2啪#2啪","娅#6娅#6娅", "加#1速#1加#1速", "嘀#1哩#1嘀#1哩", "[啪绿弯湾内色涩瑟哑娅撸噗鼠丫]#1\\1",
    ...
    "微#1[博搏勃]", "想#1[日草艹曰射]", "选#1[举民票战]", "野#1[爹妈味]", "[铸鋳]#1币", "自#1[残省重刎]",
...
rules = {
    ...
    "(?i)([%s] ?|f ?a? ?)([%s会能弄冷]|l ?u ?n)"%(hz_fa,hz_lun): insert_filler,
    ...
    "(?<!\s)([真太很好挺偏]|有一?点)(?=[^\s不]{0,3}[怪脏吓恶悪])": lambda x: " "+x.group(),
    "猥": "weiᘁ",
    "(?<!繁)琐":"suoᘁ",
    "(?<![小文])丑": "chouᘁ",
    "(?<!愚)蠢(?!蠢|欲动)": "chunᘁ",
...
list_4=[
    ...
    "的(?=[嘴脸鼻眼舌肚腿])",
    "(有一?点|真的?是?|[太很好挺偏])(?=[^\s不]{0,3}[胖矮肥傻笨蠢病疯丑菜废逊挫土臭烦老吵])",
    ...
    "你们?(?=[^\s吓笑]{0,6}[死滚])",
    "死(?=\S{0,3}[狗猪吧吗嘛啊呢哦呀么啦])",
    "[病笨傻蠢臭胖矮肥狗猪猴西土烦脏妈][蛋了]?(?=[^\s妈笨傻蠢臭胖狗脏]{0,3}[成样吧吗嘛啊呢哦呀么啦](?!\s))",
...
ex_rules={
    ...
    "滚": "gunᘁ", "妖": "yaoᐨ", "傻": "shaᘁ", "狗( ?狗)*": "gouᘁ", "脑 ?":"naoᘁ",
    "病 ?": "Ⲃingᐠ", "蠢 ?": "chunᘁ", "丑 ?": "chouᘁ", "死": "si", "炸": "zhaᐠ", "垃 ?":"laᐨ", "圾":"ji",
