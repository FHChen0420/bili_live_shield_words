...
words =  [ 
    ...
    "[.]#6c#6c", "a#6j#6p", "s#2e#2x", "t#6l#6y", "v#2p#2n", "x#4j#4p", "x#6y#6z", "a#3s#3m#3r", "f#6l#6d#6f", "n#2t#1o#1p",
...
rules = {
    ...
    # [A_B]型
    "垃圾|人妻|整容|彩笔|狒狒|闭嘴|双亲|渣女|股间|矮子|小偷|愚蠢|脑子|脏(话|东西)|臭小鬼|老太婆|滚[开滚]|你是个[Pp]|难[看听]|恶心+": lambda x: "["+x.group()[0]+" "+x.group()[1:]+"]",
    # 其他
