...
words =  [ 
    ...
    "脑子瓦特", "恐怖漫画", "乡关何处", "有容乃大", "是全裸的",
    "黑暗之魂", "求生之路", "上古卷轴", "侠盗飞车", "尸体派对", "动物之森",
    "31年", "1月23", "7月1日", "7月5日", "7月13", "8月17日", "12月28", "你是你我是我", #汉字格式的日期也会被屏蔽，这里没写出来

    ### 字符间隔相关
    "奥#1数#1[魔默]", "收#1[妹弟女]#1[妹弟儿]", "回#1来#3谢", "观#1众#3v", "姐#1姐#5[逼b]", "妹#1妹#5[逼b]", "弟#1弟#6大", "v#2p#2n", "湿#2视#2频",
    ...
    "吉#1[尔儿]", "野#1[爹妈]", "射#1[爆爽]", "乳#1[头首量]", "称#1[王皇帝]", "微#1[博搏勃]", "涩#1[气批片p]", "精#1[美日湛子]", "魂#1[一二三123]",
    ...
    "网#2恋", "巨#2乳", "自#2尽", "涩#2情", "逼#2真", "翻#2墙", "人#2[权妖]", "[逼b]#2毛", "[傻沙煞撒]#2[逼比笔]",
    "支#3那", "去#3搜", "百#3d", "自#3杀", "共#3产", "毛#3东", "手#3银", "涩#3图", "肉#3棒", "伪#3娘", "邪#3教", "果#3聊", "裸#3体",
    "[涩色]#3网", "被#3[日草艹操曰]", "[习習吊弔]#3大", "[草艹操]#3b", "[下压]#3注", "[黄色h]#3片", "[做作坐座]#3爱", 
    "六#4四", "八#4九", "车#4震", "援#4交", "后#4入", "天#4门", "流#4世", "主#4席", "黄#4网", "阴#4道", "赤#4毒", "近#4评", "孝#4子", "孤#4儿",
