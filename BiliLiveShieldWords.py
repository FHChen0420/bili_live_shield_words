...
words =  [ 
    ...
    "一哥", "动森", "鸣人", "映画", "老母", "青蛙", "秃子", "口误", "连睡",
    "黑幕", "猎奇", "冲塔", "逆行", "太安", "弹舌", "螳臂", "挡车", "全套", "自重", 
    "快排", "牛芝", "比心", "横幅", "饭友", "尚气", "赛艇", "催人", "催吐",
    ...
    "脑子瓦特", "恐怖漫画", "乡关何处", "有容乃大", "是全裸的", "最后一课", "狼吞虎咽", "时间机器", "疲劳驾驶",
    "黑暗之魂", "求生之路", "上古卷轴", "侠盗飞车", "尸体派对", "动物之森",
    "31年", "1月23", "7月1日", "7月5日", "7月13", "8月17日", "12月28", "命运共同体", "你是你我是我", #汉字格式的日期也会被屏蔽，这里没写出来

    ### 字符间隔相关
    "奥#1数#1[魔默]", "一#1口#1[气吃喝]", "收#1[妹弟女]#1[妹弟儿]", "回#1来#3谢", "观#1众#3v", "姐#1姐#5[逼b]", "妹#1妹#5[逼b]", "弟#1弟#6大", 
    ...
    "射#4身#1上", "童#4收#1养", "买#4烟#1花", "删#4评#1论", "改#4中#1国", "v#4b#3o", "天#4安#4门", "萝#4莉#4控", "正#4太#4控", 
    "加#4速#4器", "习#4大#4大", "[你尼]#4[妈吗玛马]#4[币比逼必猪狗b]",
    "手#5指#5插", "[鲁撸露]#5一#5发", "徐#5上#5爽", "许#5艾#5莉", "[徐许]#5[上玩]#5[碧双霜]",
    ...
    "支#3那", "去#3搜", "百#3d", "自#3杀", "共#3产", "毛#3东", "手#3银", "涩#3图", "肉#3棒", "伪#3娘", "邪#3教", "果#3聊", "裸#3体", "粉#3奶",
    ...
    # "书记", "想死", "屏蔽", "干妈", "垃圾", "64", "73", "89", "404", "535", "7\.5", "1\.23",
