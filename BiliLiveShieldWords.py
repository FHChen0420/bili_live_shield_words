...
words =  [ 
    ...
    "31年", "110吗", "1月23", "7月1日", "7月5日", "7月13", "8月17日", "12月28", "命运共同体", "你是你我是我", #汉字格式的日期也会被屏蔽，这里没写出来
    ...
    "[01]#2还#1是#2[01]", "你#3画#3我#3猜", "清#6透#6世#6界", "n#2t#2t#1o#1p", "w#4e#4i#4b#4o", "一#6个#6人#6寂#6寞", "不#1要#6这#1种#1事#1情", "123456789#30",
