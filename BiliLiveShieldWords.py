...
words =  [ 
    ...
    "的混合物", "波涛汹涌", "报复社会", "官方签约", "我还活着", "贤者模式", "侃侃而谈", "约德尔人", "社会主义",
...
rules = {
    ...
    "[嘴脸鼻眼脑舌](?=[^\s\d]{0,6}[胖矮丑烦笨傻蠢怪土大睁垃])": add_space,
    "[你您他她这个](?=[^\s\d]{0,3}[脸嘴鼻脑舌货猴胖矮丑烦笨傻蠢怪土歪睁垃])": add_space,
    ...
    "咖喱 ?人": "咖喱/ 人",
    "全 ?家 ?炸": "全 家/炸",
    "母韵|太笨|整形|全家|变态|孤勇者|垃圾(?!游戏)|整容|彩笔|狒狒|闭嘴|双亲|渣女|股间|矮子|小偷"+
