...
words =  [ 
    ...
    "的混合物", "波涛汹涌", "报复社会", "官方签约", "我还活着", "贤者模式", "侃侃而谈", "约德尔人",
    ...
    "手#5指#5插", "徐#5上#5爽", "许#5艾#5莉", "谢#5日#5双", "下#5面#5痒", "崔#5塔#5娜",
...
rules = {
    ...
    "咖喱 ?人": "咖喱/ 人",
    "全 ?家 ?炸": "全 家/炸",
    "母韵|太笨|整形|全家|变态|孤勇者|垃圾(?!游戏)|整容|彩笔|狒狒|闭嘴|双亲|渣女|股间|矮子|小偷|愚蠢|脑子|脏话|脏东西|臭小鬼|老太婆|你是个[Pp]|难[看听]": lambda x: x.group()[0]+" "+x.group()[1:],
    "%s(猴子|村人|爹妈|笨笨|吃的吗|断[手脖])%s"%(f1,f3): lambda x: x.group()[0]+" "+x.group()[1:],
    "尼嚎": "你好",
    "快死": "快 "+sp+"死",
    "牲畜": "牲 1畜",
    "人妖": "人 1妖",
