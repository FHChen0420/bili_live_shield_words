...
words =  [ 
    ...
    "皇帝", "磕头", "传教", "宗教", "还愿", "安乐", "包养",
    "赌博", "扑克", "彩票", "发票", "硫酸", "甲烷", "煤气",
    "爸爸", "即为", "试看", "豪迈", "耳语", "迷途", "触摸", "初心", "慎重",
    "ロリ", "はま", "ハマ", "しな", "シナ", "くま", "死ね", 

    "hw", "gc", "zf", "kui", "knee", "kuma", 
    "ilibilib", "pilipili", "dilidili", "535", "881", "1953",
    "不想活", "自由门", "咖啡因", "死灵魂", "白衬衫", "你触摸", "生理期", 
    "纪念日", "为自由", "莉莉安", "李医生", "毕业歌", "右大人",
    "自由之门", "继续前进", "并肩同行", "焕然一新", "奥斯曼人", "二氧化碳", 
    "身经百战", "黑框眼镜", "活不下去", "飘飘欲仙", "动物之森", 
    "你是你我是我",
    ...
    # "av", "sb", "小学生", "不习惯", "风平浪静", "老不死的",

    ### 字符间隔相关
    "[贫小平]#1乳", "[傻沙煞撒]#1[逼比笔]", "[草操]#3b", "被#3[草曹操]", "少女#3[下自]", "[做作坐座]#3爱", "[看好]#4胸",
    "巨#2乳", "去#3搜", "车#4震", "小#4平", "再#4任", "明#4泽", "援#4交", "后#4入", "留#5水", 
    "v#4b#3o", "道#3上#3飞", "名#3字#3看", "射#4身#4上", "大#4一#4在", "文#6古#6花", "看#6地#6方", "清#6透#6世#6界", "一#6个#6人#6寂#6寞",
    ### 拼音组合相关
